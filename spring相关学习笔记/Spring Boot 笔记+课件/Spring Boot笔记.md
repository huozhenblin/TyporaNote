...
这个是自己写的一个servlet，并打上相关注解

```java
@WebServlet(urlPatterns="/myservlet")//可以点进去注解添加相应的属性
public class MySservlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       resp.getWriter().write("hello myservvlet");
    }
}
```

然后在添加@Configuration的类中使用扫描注解@ServletComponentScan
...
public class MyServletConfig implements  WebServerFactoryCustomizer<TomcatServletWebServerFactory> {
...
public class myFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        filterChain.doFilter(servletRequest, servletResponse);//这个放行
    }
